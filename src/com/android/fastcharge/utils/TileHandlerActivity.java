...
import com.android.fastcharge.FastChargeActivity;
import com.android.fastcharge.FastChargeTileService;
...
public final class TileHandlerActivity extends Activity {
    ...
    static {
        TILE_ACTIVITY_MAP.put(FastChargeTileService.class.getName(), FastChargeActivity.class);
    }
